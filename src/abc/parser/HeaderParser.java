...
public class HeaderParser extends Parser {
    ...
    public static class FieldindexContext extends ParserRuleContext {
        ...
        public List<TerminalNode> DIGIT() {
            return getTokens(HeaderParser.DIGIT);
        }
    ...
    public static class EndoflineContext extends ParserRuleContext {
        ...
        public TerminalNode NEWLINE() {
            return getToken(HeaderParser.NEWLINE, 0);
        }
    ...
    public static class BodyContext extends ParserRuleContext {
        ...
        public TerminalNode EOF() {
            return getToken(HeaderParser.EOF, 0);
        }
        ...
        public List<TerminalNode> NEWLINE() {
            return getTokens(HeaderParser.NEWLINE);
        }
    ...
    public static class TextContext extends ParserRuleContext {
        ...
        public List<TerminalNode> CHAR() {
            return getTokens(HeaderParser.CHAR);
        }
