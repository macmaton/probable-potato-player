...
public class Tuplet implements MeasureElement {
    ...
    public NoteLength getSpecMultiplier() {
        NoteLength multiplier = null;
        switch(spec) {
            case 2:
                multiplier = new NoteLength(3, 2);
                break;
            case 3:
                multiplier = new NoteLength(2, 3);
                break;
            case 4:
                multiplier = new NoteLength(3, 4);
                break;
        }
        return multiplier;
    }
